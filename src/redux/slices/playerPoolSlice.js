...
const playerPoolSlice = createSlice({
  ...
  reducers: {
    assignPlayersToGuests: (state, action) => {
      ...
      // Randomly select one guest to be Mr. White
      ...
      // Assign players: Mr. White gets secondary, everyone else gets principal
...
export const { assignPlayersToGuests, resetPlayerPool } =
  playerPoolSlice.actions;
